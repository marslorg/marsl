...
<!-- /TinyMCE -->
<form method="post" action="gallery.php?time=<?php echo $authTime; ?>&amp;token=<?php echo $authToken; ?>">
	<table class="galtable">
		<tr>
			<td>Fotograf: </td>
			<td><input type="text" name="photograph" /></td>
		</tr>
		<tr>
			<td>Kategorie: </td>
			<td>
		...
		<tr>
			...
			<td><textarea name="description" class="midtext" rows="10"></textarea></td>
		</tr>
		<tr>
			<td colspan="2" class="center">
				<input type="hidden" name="folder" value="<?php echo $tmpDir; ?>/" />
				<button type="submit" name="action" value="new"> Absenden </button>
