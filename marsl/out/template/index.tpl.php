...
<html lang="de">
	<head>
		...
		<link rel="stylesheet" href="styles/mobile.css?v=19" type="text/css" media="all and (max-width: 1023px)" />
	...
	<body>
		...
		<div class="body">
			...
			<div class="footer">
				...
				<div class="center">
					<a href="https://www.instagram.com/music2web" target="_blank"><img src="includes/graphics/socialicons/instagram.png" height="40px" alt="Folgt uns auf Instagram" class="footericons" /></a>
					<a href="https://apps.apple.com/de/app/music2web-de/id1570808940" target="_blank"><img src="includes/graphics/app/apple.svg" height="40px" alt="Laden im App Store" class="footericons" /></a>
					<a href="https://play.google.com/store/apps/details?id=de.music2web.www&gl=DE" target="_blank"><img src="includes/graphics/app/google.png" height="40px" alt="Jetzt bei Google" class="footericons" /></a>
					<a href="https://www.facebook.com/music2web" target="_blank"><img src="includes/graphics/socialicons/facebook.png" height="40px" alt="Folgt uns auf Facebook" class="footericons" /></a>
				</div>
			</div>
